...
- id: factory-unblock-canary-codex-39
  title: Unblock canary-codex-39 (stuck CONFLICT)
  material: no
  proof: npm --prefix packages/darwin-kernel run test
  prompt: |
    Task 'canary-codex-39' has been stuck in state CONFLICT for over 60 minutes. Recorded note: train: still conflicts after 4 redos - needs manual rebase.
