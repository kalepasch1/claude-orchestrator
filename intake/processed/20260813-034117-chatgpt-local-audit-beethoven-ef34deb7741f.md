...
- id: chatgpt-local-reconcile-beethoven-ef34deb7741f
  ...
  prompt: |
    ...
    `ef34deb7741fa6073af06eaea34e5c7e501e641ec33127c426a27fa782d05d5b`, including source, classification, disposition, and resulting task/branch/commit. Completion
    ...
    [
      {
        ...
        "changes_total": 33,
        "head": "e8cf009b29928572ffecdf467178b31411729044",
        "kind": "dirty_worktree",
      ...
      },
      {
        "branches": [
          ...
          {
            "committed_at": 1785990513,
            "ref": "agent/dropbox-beethoven-audit-addendum-two-session-reconciliation-read-wit-group-1",
            "sha": "8097671a9152675a785c81ed632b7c9f9792be05",
            "subject": "agent: dropbox-beethoven-audit-addendum-two-session-reconciliation-read-wit-group-1 \u2014 unblock train: passport fix (order-independent digest, fail-closed expiry)"
          },
          {
