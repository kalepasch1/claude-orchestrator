...
- id: factory-unblock-recover-missing-branch-copyfix-beethoven-07190657-sl
  title: Unblock recover-missing-branch-copyfix-beethoven-07190657-slice-2 (stuck BLOCKED)
  material: no
  proof: npm --prefix packages/darwin-kernel run test
  prompt: |
    Task 'recover-missing-branch-copyfix-beethoven-07190657-slice-2' has been stuck in state BLOCKED for over 60 minutes. Recorded note: bankrupted 2026-08-02: quarantine backlog reached 717 rows against 79 lifetime completions. Cleared in bulk to stop rework chains respawning; re-open individually if still wanted.
