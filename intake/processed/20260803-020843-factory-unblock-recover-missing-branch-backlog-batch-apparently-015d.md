...
- id: factory-unblock-recover-missing-branch-backlog-batch-apparently-015d
  title: Unblock recover-missing-branch-backlog-batch-apparently-015d6d4-adapt-lint-code-adapt-lint-diffs-slice-4 (stuck BLOCKED)
  material: no
  proof: npm run typecheck
  prompt: |
    Task 'recover-missing-branch-backlog-batch-apparently-015d6d4-adapt-lint-code-adapt-lint-diffs-slice-4' has been stuck in state BLOCKED for over 60 minutes. Recorded note: bankrupted 2026-08-02: quarantine backlog reached 717 rows against 79 lifetime completions. Cleared in bulk to stop rework chains respawning; re-open individually if still wanted.
