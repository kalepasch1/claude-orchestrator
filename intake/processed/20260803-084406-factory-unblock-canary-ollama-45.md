...
- id: factory-unblock-canary-ollama-45
  title: Unblock canary-ollama-45 (stuck SHELVED)
  material: no
  proof: npm --prefix packages/darwin-kernel run test
  prompt: |
    Task 'canary-ollama-45' has been stuck in state SHELVED for over 60 minutes. Recorded note: shelved by queue-velocity PID (low EV, integral too high)
