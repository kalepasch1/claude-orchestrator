...
Generated 2026-08-12T12:45:52.892410+00:00 against `origin/master`.
Read-only inventory. No branch was merged and no task state was changed to
produce it.

## Totals

- agent/* branches on origin: **962**
- already merged into master: **768**
- **STRANDED (not an ancestor of master): 194**
  - merge cleanly today: **124**
  - would conflict: **70**

- real source lines added across the stranded set: **276,374**
...
| `canary-codex-55` | 9.9 | +13/-51 | 4 | — no task row — |
| `improve-enhanced-testing-pipeline-missing-branch-r-slice-1` | 9.9 | +346/-4 | 2 | — no task row — |
...
| `copyfix-beethoven-07180848-slice-3-public-landing-hero-control-copy` | 6.5 | +4/-4 | 1 | — no task row — |
...
| `improve-automate-branch-management-slice-3` | 6.3 | +61/-0 | 1 | — no task row — |
...
| `improve-missing-branch-auto-creator-slice-3-connect-event-to-branch-creation` | 6.1 | +127/-1 | 2 | — no task row — |
...
| `dropbox-hisanta-mastery-engine-grandma-rail-family-slice-1` | 5.8 | +254/-27 | 3 | — no task row — |
| `dropbox-mission-complete-merge-and-deploy-the-full-backlog-to-vercel-billing-guard-scope` | 5.8 | +514/-76 | 2 | — no task row — |
...
| `dropbox-beethoven-fleet-immune-system-throughput-a-slice-2` | 5.6 | +185/-12 | 2 | — no task row — |
| `improve-upgrade-to-a-high-performance-database-slice-3-integrate-new-module` | 5.6 | +163/-32 | 4 | — no task row — |
| `dropbox-beethoven-audit-addendum-two-session-recon-slice-2` | 5.5 | +644/-3 | 3 | — no task row — |
| `dropbox-wave-c-compounding-codegen-platform-spine--slice-3` | 5.5 | +696/-0 | 2 | — no task row — |
...
| `dropbox-wave-c-compounding-codegen-platform-spine--slice-5-resolve-passport-sour` | 3.6 | +8/-0 | 2 | — no task row — |
| `dropbox-recover-the-lease-night-stash-work-branch-hotfix-stash-rescu-group-3-res` | 1.7 | +8/-0 | 2 | — no task row — |
...
| `dropbox-beethoven-audit-addendum-two-session-recon-slice-5-implement-core-logic` | 1.1 | +225/-7 | 2 | — no task row — |
| `dropbox-beethoven-fleet-immune-system-throughput-accelerators-operat-contracts-d` | 1.1 | +425/-0 | 3 | — no task row — |
| `dropbox-beethoven-fleet-immune-system-throughput-accelerators-operat-contracts-t` | 1.1 | +595/-0 | 2 | — no task row — |
| `dropbox-prompt-merged-diff-memory-system-task-spec-slice-5` | 1.1 | +192/-9 | 2 | — no task row — |
...
| `chatgpt-local-reconcile-beethoven-286879fa5fe4` | 0.1 | +44697/-0 | 6 | — no task row — |
| `chatgpt-local-reconcile-beethoven-44d6bb63e4fc` | 0.1 | +44697/-0 | 6 | — no task row — |
| `chatgpt-local-reconcile-beethoven-a92ff481c0ba` | 0.1 | +595/-0 | 2 | — no task row — |
| `dropbox-beethoven-audit-addendum-two-session-recon-slice-1-integrate-core-logic` | 0.1 | +312/-0 | 3 | — no task row — |
| `dropbox-beethoven-audit-addendum-two-session-recon-slice-1-refactor-for-cleanlin` | 0.1 | +382/-14 | 2 | — no task row — |
| `dropbox-beethoven-audit-addendum-two-session-recon-slice-1-verify-behavioral-equ` | 0.1 | +235/-0 | 1 | — no task row — |
| `dropbox-beethoven-fleet-immune-system-throughput-accelerators-operat-contracts-c` | 0.1 | +938/-10 | 11 | — no task row — |
| `dropbox-hisanta-mastery-engine-grandma-rail-family-slice-3-integrate-adapted-cha` | 0.1 | +300/-122 | 5 | — no task row — |
| `dropbox-wave-c-compounding-codegen-platform-spine--slice-1-define-core-types-cre` | 0.1 | +11/-0 | 1 | — no task row — |
| `dropbox-wave-c-compounding-codegen-platform-spine--slice-1-define-core-types-def` | 0.1 | +526/-0 | 9 | — no task row — |
...
| `improve-runner-credential-capacity-failover` | 0.1 | +846/-0 | 3 | — no task row — |
| `p1-artifact-commit-fanout-is-not-evidence-20260812` | 0.1 | +5186/-0 | 5 | — no task row — |
...
| `convention-conformance-lints` | 39.7 | +222/-2 | 4 | unclear | — no task row — |
...
| `canary-codex-34` | 12.4 | +32/-2 | 3 | unclear | — no task row — |
| `canary-codex-39` | 12.3 | +74/-12 | 5 | unclear | — no task row — |
| `canary-codex-46` | 11.5 | +61/-0 | 3 | unclear | — no task row — |
| `qafix-beethoven-08010307` | 10.5 | +28/-0 | 1 | unclear | — no task row — |
| `canary-claude-27-slice-1` | 10.4 | +4191/-2 | 9 | unclear | — no task row — |
| `canary-xai-6` | 9.7 | +2158/-0 | 5 | unclear | — no task row — |
| `relfix-beethoven-299c6b3c3bc6` | 8.4 | +2/-2 | 1 | unclear | — no task row — |
...
| `dropbox-beethoven-fleet-immune-system-throughput-accelerators-operat-proofs` | 6.7 | +1481/-0 | 8 | unclear | — no task row — |
...
| `dropbox-beethoven-audit-addendum-two-session-recon-slice-5` | 6.3 | +514/-5 | 3 | unclear | — no task row — |
| `dropbox-beethoven-audit-addendum-two-session-reconciliation-read-wit-group-1` | 6.3 | +551/-7 | 5 | unclear | — no task row — |
| `dropbox-beethoven-audit-addendum-two-session-reconciliation-read-wit-group-3` | 6.3 | +528/-5 | 4 | unclear | — no task row — |
| `dropbox-beethoven-fleet-immune-system-throughput-accelerators-operat-contracts` | 6.3 | +698/-5 | 4 | unclear | — no task row — |
| `dropbox-recover-the-lease-night-stash-work-branch-hotfix-stash-rescu-group-3` | 6.3 | +277/-13 | 3 | unclear | — no task row — |
| `dropbox-wave-c-compounding-codegen-platform-spine--slice-4` | 6.3 | +514/-5 | 3 | unclear | — no task row — |
| `dropbox-wave-c-compounding-codegen-platform-spine--slice-5` | 6.3 | +925/-5 | 6 | unclear | — no task row — |
...
| `merged-diff-memory` | 6.1 | +343/-4 | 2 | unclear | — no task row — |
| `prompt-evolution-bandit` | 6.1 | +17/-4 | 1 | unclear | — no task row — |
| `improve-missing-branch-auto-creator-slice-3-fix-base-branch-detection-clean-022922` | 6.0 | +118/-493 | 3 | unclear | — no task row — |
| `improve-missing-branch-auto-recovery-fleet-wide-slice-3-identify-owner-module` | 5.9 | +5424/-21 | 33 | unclear | — no task row — |
...
| `dropbox-mission-complete-merge-and-deploy-the-full-backlog-to-vercel-hermetic-worktree-preflight` | 5.8 | +487/-0 | 2 | unclear | — no task row — |
...
| `relfix-beethoven-299c6b3c3bc6-recovered` | 5.7 | +90/-268 | 69 | unclear | — no task row — |
...
| `done-to-merged-is-the-new-bottleneck-cowork-20260806` | 5.6 | +937/-4 | 4 | unclear | — no task row — |
| `factory-unblock-improve-immediate-auto-merge-on-te-slice-4-fix-compilation-types` | 5.6 | +148/-44 | 29 | unclear | — no task row — |
| `backlog-batch-beethoven-22ee5bc-prompt-evolution-bandit-implement-performance-tr` | 5.5 | +605/-8 | 2 | unclear | — no task row — |
| `dropbox-mission-complete-merge-and-deploy-the-full-backlog-to-vercel-batch-fusion-unpause` | 5.5 | +181/-9 | 2 | unclear | — no task row — |
| `dropbox-prompt-merged-diff-memory-system-task-spec-group-10` | 5.5 | +689/-13 | 4 | unclear | — no task row — |
| `dropbox-prompt-merged-diff-memory-system-task-spec-group-19-wire-merge-detection` | 5.5 | +279/-2 | 2 | unclear | — no task row — |
