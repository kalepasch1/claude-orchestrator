...
Audit fingerprint: `91e42592f1584d0737b398563e52050ee7988072b76aed18d8c4de8bbac0881d`

Base: `origin/master` @ `bcacf428ecb1` · generated 2026-09-10T06:40:33.742Z

Regenerate with:

```bash
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint 91e42592f1584d0737b398563e52050ee7988072b76aed18d8c4de8bbac0881d \
  --out docs/recovery-ledger-91e42592f158.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-91e42592f158.json --project beethoven
```

## Result

**784 evidence items classified, 0 UNKNOWN.** The evidence source was treated as read-only throughout — nothing was deleted, reset, cleaned, popped or moved. Classification is recomputed from live refs, not from the snapshot in the task prompt.

| Classification | Count | Disposition |
|---|---:|---|
| CONFLICTED_NEEDS_FOCUSED_TASK | 151 | queue a focused conflict-resolution task; never force-overwrite |
| ACTIVE_IN_ANOTHER_TASK | 33 | no action — leave to the owning branch/task; do not duplicate |
| SUPERSEDED_BY_NEWER | 362 | no action — newer implementation on the default branch wins |
| ALREADY_PRESENT | 238 | no action — value already on the default branch |

## Items with remaining value

151 item(s) below keep durable provenance in `docs/recovery-ledger-91e42592f158.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
...
| `20260909T054308-5bee398fbf584c3252b3-6bb0189f` | CONFLICTED_NEEDS_FOCUSED_TASK | 2234 | On (no branch): orch-rescue: periodic sweep |
