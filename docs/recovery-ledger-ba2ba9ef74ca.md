...
Audit fingerprint: `ba2ba9ef74ca0f32dee71b236dd11d873c38ecaca0adb3959106fdcc19af56ef`

Base: `origin/master` @ `817651866444` · generated 2026-09-10T07:05:58.806Z

Regenerate with:

```bash
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint ba2ba9ef74ca0f32dee71b236dd11d873c38ecaca0adb3959106fdcc19af56ef \
  --out docs/recovery-ledger-ba2ba9ef74ca.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-ba2ba9ef74ca.json --project beethoven
```
...
148 item(s) below keep durable provenance in `docs/recovery-ledger-ba2ba9ef74ca.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
