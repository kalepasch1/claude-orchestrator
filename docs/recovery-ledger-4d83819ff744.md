...
Audit fingerprint: `4d83819ff744fb4dfdfe51ae05b9c1b9ce3e2348c2678bf59da7408f20a3ab94`
...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint 4d83819ff744fb4dfdfe51ae05b9c1b9ce3e2348c2678bf59da7408f20a3ab94 \
  --out docs/recovery-ledger-4d83819ff744.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-4d83819ff744.json --project beethoven
```
...
33 item(s) below keep durable provenance in `docs/recovery-ledger-4d83819ff744.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
