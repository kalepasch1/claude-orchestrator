...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint 671c267eedf3f831e2dca9ef7f81cdf779a194fc5bd534e339e471804ce8f004 \
  --out docs/recovery-ledger-671c267eedf3.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-671c267eedf3.json --project beethoven
```
...
33 item(s) below keep durable provenance in `docs/recovery-ledger-671c267eedf3.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
