...
- audit fingerprint: `b7595ef3f8c34decbe15f203e1b5a0350d3203fe3307c224f975224f322cb3e9`
- base: `origin/master`
...
| `/Users/kpasch/Documents/beethoven/claude-orchestrator-wt/counterfactual-replay` | `bae16db4b7` | RECOVERABLE_VALUE | 1 | 1 uncommitted path(s); tracked diff applies to base. Recover via a new isolated worktree + agent branch. Source worktree left untouched. |
