...
Audit fingerprint: `ca93a1b7be55ff70739859b71b5dfc22d33249ce2cb8f0d69a51c4ff70b76dfc`
...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint ca93a1b7be55ff70739859b71b5dfc22d33249ce2cb8f0d69a51c4ff70b76dfc \
  --out docs/recovery-ledger-ca93a1b7be55.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-ca93a1b7be55.json --project beethoven
```
...
33 item(s) below keep durable provenance in `docs/recovery-ledger-ca93a1b7be55.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
