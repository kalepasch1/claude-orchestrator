...
Audit fingerprint: `bbe04ee29454a07894fdc8faacaa2f302139c8c9d9869853d90fb5f2ce23ef5e`

Base: `origin/master` @ `817651866444` · generated 2026-09-10T07:06:02.073Z

Regenerate with:

```bash
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint bbe04ee29454a07894fdc8faacaa2f302139c8c9d9869853d90fb5f2ce23ef5e \
  --out docs/recovery-ledger-bbe04ee29454.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-bbe04ee29454.json --project beethoven
```
...
148 item(s) below keep durable provenance in `docs/recovery-ledger-bbe04ee29454.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
