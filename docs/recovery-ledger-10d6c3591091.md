...
Audit fingerprint: `10d6c3591091d83d24362f4dd80bd7207958dc5dcd88a36a63bdcfd244999fb0`
...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint 10d6c3591091d83d24362f4dd80bd7207958dc5dcd88a36a63bdcfd244999fb0 \
  --out docs/recovery-ledger-10d6c3591091.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-10d6c3591091.json --project beethoven
```
...
33 item(s) below keep durable provenance in `docs/recovery-ledger-10d6c3591091.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
