...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint fa219072749ec06c9edef769e81e2796706a40ea501490babb192eb61b9c99d1 \
  --out docs/recovery-ledger-fa219072749e.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-fa219072749e.json --project beethoven
```
...
32 item(s) below keep durable provenance in `docs/recovery-ledger-fa219072749e.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
