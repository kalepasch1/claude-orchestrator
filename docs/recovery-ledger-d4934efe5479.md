...
Audit fingerprint: `d4934efe5479641fdfb6961987179af184740dba7c61c43b21aa0ea1bab76b1a`
...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint d4934efe5479641fdfb6961987179af184740dba7c61c43b21aa0ea1bab76b1a \
  --out docs/recovery-ledger-d4934efe5479.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-d4934efe5479.json --project beethoven
```
...
148 item(s) below keep durable provenance in `docs/recovery-ledger-d4934efe5479.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
