...
Audit fingerprint: `797668765dadc46fb8db77d3a328370af1e4bcf6a0d717997fcd1d83cb0f85f9`
...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint 797668765dadc46fb8db77d3a328370af1e4bcf6a0d717997fcd1d83cb0f85f9 \
  --out docs/recovery-ledger-797668765dad.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-797668765dad.json --project beethoven
```
...
34 item(s) below keep durable provenance in `docs/recovery-ledger-797668765dad.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
...
`797668765dad`, `ac93979d6c7a` and `85d2de799d5d` were queued against this same repository
...
purposes; the conflicted items should be de-duplicated before follow-up work is scheduled.
