...
- audit fingerprint: `22184dce064ba7d86c559acbf71de3b86fec977e9475e3db331a95f1e69c98ab`
- base: `origin/master`
- evidence items classified: **716**
- UNKNOWN remaining: **0**
...
| `/Users/kpasch/Documents/beethoven/claude-orchestrator-wt/orch-config-consumption` | `bae16db4b7` | RECOVERABLE_VALUE | 1 | 1 uncommitted path(s); tracked diff applies to base. Recover via a new isolated worktree + agent branch. Source worktree left untouched. |
