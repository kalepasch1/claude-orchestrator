...
Audit fingerprint: `e4b9212494ba40d01ad506e0365ad85dc597491e8da929b2df8039e00774ced0`
...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint e4b9212494ba40d01ad506e0365ad85dc597491e8da929b2df8039e00774ced0 \
  --out docs/recovery-ledger-e4b9212494ba.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-e4b9212494ba.json --project beethoven
```
...
33 item(s) below keep durable provenance in `docs/recovery-ledger-e4b9212494ba.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
