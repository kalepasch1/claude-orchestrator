...
Audit fingerprint: `550e33ed0a9b6bd0ed0b3c4f63cb3f4ada2076d79a502c1cfa09c18f0caad52e`

Base: `origin/master` @ `817651866444` · generated 2026-09-10T07:23:51.833Z

Regenerate with:

```bash
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint 550e33ed0a9b6bd0ed0b3c4f63cb3f4ada2076d79a502c1cfa09c18f0caad52e \
  --out docs/recovery-ledger-550e33ed0a9b.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-550e33ed0a9b.json --project beethoven
```

## Result

**787 evidence items classified, 0 UNKNOWN.** The evidence source was treated as read-only throughout — nothing was deleted, reset, cleaned, popped or moved. Classification is recomputed from live refs, not from the snapshot in the task prompt.
...
148 item(s) below keep durable provenance in `docs/recovery-ledger-550e33ed0a9b.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
