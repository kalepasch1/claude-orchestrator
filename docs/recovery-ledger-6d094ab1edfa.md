...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint 6d094ab1edfac0769beccf2f67142c12e080d3e6c66ad17e86580385391b22d0 \
  --out docs/recovery-ledger-6d094ab1edfa.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-6d094ab1edfa.json --project beethoven
```
...
33 item(s) below keep durable provenance in `docs/recovery-ledger-6d094ab1edfa.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
