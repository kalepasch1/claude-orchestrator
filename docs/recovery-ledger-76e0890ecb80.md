...
Audit fingerprint: `76e0890ecb800565d3ca245b262dd7d5fa294ac0a6b4f4d17e4d687f2ae8e94a`
...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint 76e0890ecb800565d3ca245b262dd7d5fa294ac0a6b4f4d17e4d687f2ae8e94a \
  --out docs/recovery-ledger-76e0890ecb80.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-76e0890ecb80.json --project beethoven
```
...
148 item(s) below keep durable provenance in `docs/recovery-ledger-76e0890ecb80.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
