...
Audit fingerprint: `d6ab3873f38e3e570bf5b8e175b33a5c3f0275d7841f80d495c178510e8d9696`

Base: `origin/master` @ `51187189545a` · generated 2026-08-15T23:22:38.801Z

Regenerate with:

```bash
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint d6ab3873f38e3e570bf5b8e175b33a5c3f0275d7841f80d495c178510e8d9696 \
  --out docs/recovery-ledger-d6ab3873f38e.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-d6ab3873f38e.json --project beethoven
```

## Result

**538 evidence items classified, 0 UNKNOWN.** The evidence source was treated as read-only throughout — nothing was deleted, reset, cleaned, popped or moved. Classification is recomputed from live refs, not from the snapshot in the task prompt.

| Classification | Count | Disposition |
|---|---:|---|
| CONFLICTED_NEEDS_FOCUSED_TASK | 32 | queue a focused conflict-resolution task; never force-overwrite |
| ACTIVE_IN_ANOTHER_TASK | 15 | no action — leave to the owning branch/task; do not duplicate |
| SUPERSEDED_BY_NEWER | 322 | no action — newer implementation on the default branch wins |
| ALREADY_PRESENT | 169 | no action — value already on the default branch |

## Items with remaining value

32 item(s) below keep durable provenance in `docs/recovery-ledger-d6ab3873f38e.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
...
| `20260815T230608-claude-orchestrator-6beec314` | CONFLICTED_NEEDS_FOCUSED_TASK | 19 | Merge branch 'agent/dropbox-wave-c-compounding-codegen-platform-spine--slice-5-r |
| `20260815T230027-claude-orchestrator-f049ff3b` | CONFLICTED_NEEDS_FOCUSED_TASK | 18 | Merge branch 'agent/chatgpt-local-reconcile-beethoven-764fd6ce53c9' (auto-resolv |
| `20260815T224825-claude-orchestrator-bf19be4d` | CONFLICTED_NEEDS_FOCUSED_TASK | 14 | fix(sweeper): honour the project pause — 'paused' must mean no writes of any kin |
