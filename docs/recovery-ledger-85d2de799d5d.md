...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint 85d2de799d5d7001150165432605b7b60bd32907bde50b5710b19b9d9ecb9b16 \
  --out docs/recovery-ledger-85d2de799d5d.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-85d2de799d5d.json --project beethoven
```
...
34 item(s) below keep durable provenance in `docs/recovery-ledger-85d2de799d5d.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
