...
Audit fingerprint: `c54c216bc5d30d3602146f1c05defc02385404e34587fb59d7aeb35e595a68c3`
...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint c54c216bc5d30d3602146f1c05defc02385404e34587fb59d7aeb35e595a68c3 \
  --out docs/recovery-ledger-c54c216bc5d3.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-c54c216bc5d3.json --project beethoven
```
...
33 item(s) below keep durable provenance in `docs/recovery-ledger-c54c216bc5d3.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
