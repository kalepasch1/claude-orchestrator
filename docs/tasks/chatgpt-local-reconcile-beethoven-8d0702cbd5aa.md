...
`origin/master`, under audit fingerprint `8d0702cbd5aa9e9fd4343cdf42c20f73f498d32891d59b1685a1bbe136065a62`.
...
`refs/orch-preserved/chatgpt-local-reconcile-beethoven-8d0702cbd5aa-attempt-prior` before the agent branch was
...
Ledger: `.orch/recovery-ledger-8d0702cbd5aa.json` — **645 evidence items, 0 UNKNOWN**.
...
| `orchestrator_rescue_refs` | 192 | 285 | 2 | 52 | 43 |
...
Every row below is carried by this task: branch `agent/chatgpt-local-reconcile-beethoven-8d0702cbd5aa`, commit: the tip of that
...
| `/Users/kpasch/Documents/beethoven/claude-orchestrator-wt/chatgpt-local-reconcile-beethoven-671c267eedf3` | dirty_worktree | `d3a6b47abff4` | 2 uncommitted path(s); tracked diff applies to base. Recover via a new isolated worktree + agent branch. Source worktree left untouched. |
...
One `coordination_tasks` record per evidence item (645 rows), `task_type =
