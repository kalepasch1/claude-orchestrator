...
Audit fingerprint: `d854da55ab98fcd157f7529c083b74739c2a80462daffa7830315b5ea4e99125`
...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint d854da55ab98fcd157f7529c083b74739c2a80462daffa7830315b5ea4e99125 \
  --out docs/recovery-ledger-d854da55ab98.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-d854da55ab98.json --project beethoven
```
...
33 item(s) below keep durable provenance in `docs/recovery-ledger-d854da55ab98.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
