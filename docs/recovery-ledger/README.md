...
`docs/recovery-ledger/6e398b6bdfef.json`, produced by `scripts/reconcile-evidence.mjs`.
...
**1099 items** classified against `origin/master`, **zero UNKNOWN, zero CONFLICTED**:
