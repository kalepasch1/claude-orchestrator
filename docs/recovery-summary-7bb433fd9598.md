...
- audit fingerprint: `7bb433fd95983458cb725f90252bef86b66935c9af51155baca7f565e2822081`
- base: `origin/master`
- evidence items classified: **712**
- UNKNOWN remaining: **0**
...
| `/Users/kpasch/Documents/beethoven/claude-orchestrator-wt/orch-config-consumption` | `bae16db4b7` | RECOVERABLE_VALUE | 2 | 2 uncommitted path(s); tracked diff applies to base. Recover via a new isolated worktree + agent branch. Source worktree left untouched. |
