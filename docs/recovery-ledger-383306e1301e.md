...
Audit fingerprint: `383306e1301ecc983b515e8cd00f2da73ae8802250ba9ce0c5c20ec58c8db160`
...
node scripts/reconcile-rescue-refs.mjs --base origin/master \
  --fingerprint 383306e1301ecc983b515e8cd00f2da73ae8802250ba9ce0c5c20ec58c8db160 \
  --out docs/recovery-ledger-383306e1301e.json
node scripts/recovery-ledger-report.mjs --ledger docs/recovery-ledger-383306e1301e.json --project beethoven
```
...
33 item(s) below keep durable provenance in `docs/recovery-ledger-383306e1301e.json` (source ref, sha, subject, touched files, carrier branches). None were applied in this pass — per the coordination rule, conflicts get a focused follow-up rather than a forced overwrite.
