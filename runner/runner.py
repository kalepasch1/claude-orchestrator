...
_SCHEDULE = [
    ...
    # Anticipatory corpus builder: expands the docket from (business model x reg axis x AI-usage)
    ...
    ("canarywatch-300","canarywatch",       "interval", 300),  # swarm bots #5+#3: triage a red self-deploy canary (it blocks ALL deploys)
...
_LEAN_MODE_SKIP = {"colosseum.py", "cade_tournaments.py", "agentmarket",
                   ...
                   "expert_corps.py", "legal_docket.py", "benchmark_redlines.py", "corpus_forecaster.py"}
