#!/usr/bin/env python3
"""
decision_drafts.py - auto-draft artifacts when founders choose directives.
...
it to the decision_processes row for one-tap review + send.
    ...
    python3 decision_drafts.py                        # poll and process pending directives
    python3 decision_drafts.py --test                 # run local unit tests
"""
