...
# Tier 0:  Claude Max (3 plans, $0 marginal)
# Tier 0b: Groq free tier (30 RPM, 1000 RPD, $0)
# Tier 0c: Google AI Studio free tier (1500 RPD Flash, $0)
# Tier 0d: ChatGPT Plus/Pro (via aider, flat monthly)
# Tier 0e: Gemini Advanced (via aider, flat monthly)
_SUB_PROVIDERS = [
    # -- Claude Max ($0 marginal, best quality, always first) --
    ...
    {"provider": "gemini",  "model": "gemini-3-flash",    "coder": "aider",
     "tiers": {"fast"}},
    # -- ChatGPT subscription (via aider, uses Plus/Pro tokens) --
    {"provider": "chatgpt", "model": "gpt-5.4-mini",      "coder": "aider",
     "tiers": {"fast", "mid"}},
    # -- Gemini subscription (via aider, uses Advanced tokens) --
