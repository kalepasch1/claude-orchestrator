...
Also exposes its own liveness at GET /metrics (plain text) on CANARY_METRICS_PORT
(default 8000) via start_metrics_server(); startup is fail-soft and idempotent.
"""
