...
object: {"verdict":"pass"|"fail","notes":"<=2 sentences"}. Diff:
"""


def review_diff(worktree, base="main", max_chars=60000):
    try:
    ...
    try:
        ...
        d = json.loads(m.group(0)) if m else {"verdict": "pass", "notes": "unparZable; defaulting pass"}
