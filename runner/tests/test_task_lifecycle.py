...
class TestHeartbeatMechanics(unittest.TestCase):
    ...
    def test_schema_lag_preserves_runtime_identity(self):
        ...
        self.assertIn("commits_behind", attempts[0])
        self.assertNotIn("commits_behind", attempts[1])
        self.assertEqual(attempts[1]["code_sha"], proof["code_sha"])
        self.assertEqual(attempts[1]["contract_hash"], proof["contract_hash"])
