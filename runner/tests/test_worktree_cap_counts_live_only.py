...
class TestCheckWorktreeCount:
    ...
    def test_a_genuine_overrun_still_blocks(self, monkeypatch, tmp_path):
        ...
        # Warm pool zeroed: the cap budget is max + warm, and this test is about
        # the cap, not the provisioned pool. See test_worktree_cap_guardrail.
        monkeypatch.setenv("ORCH_WARM_WORKTREES", "0")
        monkeypatch.setenv("ORCH_GUARDRAIL_MODE", "block")
