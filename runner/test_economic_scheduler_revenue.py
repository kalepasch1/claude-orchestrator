...
# Read the band from the module rather than re-deriving it from the env with a second
# hardcoded default. Two independent reads of the same variable with different defaults is
# how this suite came to look like it contradicted test_economic_scheduler.py.
BAND = es.CONFIDENCE_BAND
