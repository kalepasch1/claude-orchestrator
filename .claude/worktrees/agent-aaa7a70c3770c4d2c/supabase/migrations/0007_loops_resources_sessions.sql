-- v3.6: per-app autonomous loops (managed by the orchestrator), resource governance, and
-- session next-step decisions.
create table if not exists loops (
  id uuid primary key default gen_random_uuid(),
  project text not null, type text not null,        -- learn|remediate|optimize|review
