...
class ApprovalStatus(Enum):
    """State of a parent approval request.

    Referenced by ParentApproval below. It was defined only in the nested copy, so
    the union in this file inherited the reference without the definition and the
