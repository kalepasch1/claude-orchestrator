...
CANONICAL MODULE. ``hisanta/hisanta/contracts/family.py`` is a re-export shim of
this file. That direction is not arbitrary: hisanta/tests/test_family_contract_single_source.py
asserts it ("A shim re-exports; it does not declare"), and every consumer spells
the import ``hisanta.contracts.family``, which resolves HERE.
