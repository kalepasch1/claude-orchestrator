...
class ApprovalStatus(Enum):
    """Outcome of a parent approval. Referenced by ParentApproval.status and by
    hisanta/hisanta/gifting/protocol.py; it was lost in the conflict that left this
    file unparseable, which is why ParentApproval could not even be defined."""
    APPROVED = "approved"
    DENIED = "denied"
    PENDING = "pending"
