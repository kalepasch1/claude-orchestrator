...
#: Where the one definition lives, and the module object the names above came from.
#: test_contract_singleton asserts against these, which is the check that stops the
#: duplicate growing back. Do not add definitions to this file — add them to
#: hisanta/contracts/family.py and extend the import list above.
import hisanta.contracts.family as _canonical  # noqa: E402  (re-export bookkeeping)
