...
SUBMITTED-BY: kale@smrter.us (operator/counsel) via Cowork strategy session 2026-07-28. Strategy reference: PORTFOLIO_STRATEGY_V2 Part 11.1-11.3 (READ FIRST). (Rename to PROMPT-… to activate AFTER the current tomorrow wave's standby/warehouse/console tasks have merged to dev — this EXTENDS that work.)
