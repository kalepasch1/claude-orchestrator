...
<template>
  <main class="landing">
    ...
    <section class="outcome-loop">
      ...
      <div class="loop-console">
        ...
        <ol>
          ...
          <li><time>09:41:10</time><b>TERRAIN</b><span>Maps portfolio effects and hidden dependencies</span><i>✓</i></li>
          <li><time>09:41:13</time><b>ROUTES</b><span>Intelligence Network compares cost, quality, speed, and risk</span><i>✓</i></li>
    ...
    <section class="intelligence network-section">
      <div class="intelligence network-copy">
        <p>Embedded capability intelligence network</p>
