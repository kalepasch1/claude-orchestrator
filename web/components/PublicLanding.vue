  ...
  <main class="landing">
    ...
    <section class="outcome-loop">
      <div class="loop-copy">
        ...
        <h2>You choose the destination.<br>The network navigates.</h2>
      ...
      <div class="loop-console">
        ...
        <ol>
          ...
          <li><time>09:41:13</time><b>ROUTES</b><span>Options compared on cost, quality, speed, and risk</span><i>✓</i></li>
