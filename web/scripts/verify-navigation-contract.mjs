...
const expected = [['Command Center','/'],['Sign-offs','/sign-offs'],['Queue','/queue'],['Orchestrators','/orchestrators'],['Connections','/connectors'],['Digital Twin','/digital-twin'],['Spend & ROI','/spend'],['Hivemind','/hivemind'],['Loops','/loops'],['Inbox','/inbox'],['Fleet','/fleet'],['Health','/health']]
...
if (!source.includes('NAVIGATION_CONTRACT_VERSION = 2')) throw new Error('Navigation contract version must be 2.')
