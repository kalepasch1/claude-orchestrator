...
const sections = [
  ...
  { label: 'Assurance', items: [['Capability passport','/admin/capability-passport','◇'],['Compliance','/admin/compliance','✓'],['Regulatory','/admin/regulatory','§'],['Data steering','/admin/data-steering','⛁'],['Policies','/admin/policies','≡'],['Gateway','/admin/gateway','↔']] },
