...
exports.default = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var body, _a, run_id, project_id, supabase, error;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, readBody(event)];
            case 1:
                body = _b.sent();
                _a = body !== null && body !== void 0 ? body : {}, run_id = _a.run_id, project_id = _a.project_id;
                ...
                return [4 /*yield*/, supabase.from('tasks').insert({
                        project_id: project_id,
                        slug: "replay-".concat(run_id.slice(0, 8)),
                        prompt: "REPLAY:".concat(run_id),
                        kind: 'replay',
                        state: 'QUEUED',
                    })];
            case 2:
