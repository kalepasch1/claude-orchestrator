...
exports["default"] = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var body, _a, receiptId, undoneBy, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, readBody(event)];
            case 1:
                body = _b.sent();
                _a = body || {}, receiptId = _a.receiptId, undoneBy = _a.undoneBy;
                if (!receiptId) {
                    throw createError({ statusCode: 400, statusMessage: 'receiptId is required' });
                }
                return [4 /*yield*/, (0, temporalAdmin_1.undoAction)(receiptId, undoneBy || 'operator')];
            case 2:
                result = _b.sent();
                if (!result.success) {
                    throw createError({ statusCode: 422, statusMessage: result.error || 'Undo failed' });
                }
                return [2 /*return*/, { success: true, receiptId: receiptId }];
        }
    });
}); });
