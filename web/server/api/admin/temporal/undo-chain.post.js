...
exports["default"] = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var body, _a, chainId, undoneBy, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, readBody(event)];
            case 1:
                body = _b.sent();
                _a = body || {}, chainId = _a.chainId, undoneBy = _a.undoneBy;
                if (!chainId) {
                    throw createError({ statusCode: 400, statusMessage: 'chainId is required' });
                }
                return [4 /*yield*/, (0, temporalAdmin_1.undoChain)(chainId, undoneBy || 'operator')];
            case 2:
                result = _b.sent();
