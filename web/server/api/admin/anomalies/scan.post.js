...
exports["default"] = defineEventHandler(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, {
                        ...
                        scannedApps: alerts.length > 0
                            ? __spreadArray([], new Set(alerts.map(function (a) { return a.app; })), true) : [],
                        summary: {
                            total: alerts.length,
            ...
            case 2:
                e_1 = _a.sent();
                console.error('[AnomalyRadar] full scan error:', e_1);
                throw createError({
                    statusCode: 500,
                    message: e_1.message || 'Full anomaly scan failed'
                });
