...
exports["default"] = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var q, tags, recordings, active;
    return __generator(this, function (_a) {
        try {
            q = getQuery(event);
            tags = q.tags ? q.tags.split(',').map(function (t) { return t.trim(); }).filter(Boolean) : undefined;
            recordings = (0, actionReplay_1.getRecordings)(tags);
            active = (0, actionReplay_1.getActiveRecording)();
            return [2 /*return*/, {
