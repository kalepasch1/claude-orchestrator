...
exports["default"] = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                body = _a.sent();
                if (!(body === null || body === void 0 ? void 0 : body.canaryApp)) {
                    throw createError({ statusCode: 400, message: 'canaryApp is required' });
                }
                if (!(body === null || body === void 0 ? void 0 : body.targetApps) || body.targetApps.length === 0) {
                    throw createError({ statusCode: 400, message: 'targetApps must be a non-empty array' });
                }
                plan = (0, canaryDeploy_1.createDeployPlan)(body.canaryApp, body.targetApps, body.commitSha);
                // Execute asynchronously — don't await, let it run in background
                (0, canaryDeploy_1.executeCanaryDeploy)(plan.id)["catch"](function (e) {
