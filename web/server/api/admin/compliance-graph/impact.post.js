...
var complianceGraph_1 = require("~/server/utils/complianceGraph");
exports["default"] = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var body, _a, triggerApp, triggerAction, entityType, entityId, analysis;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, readBody(event)];
            case 1:
                body = _b.sent();
                _a = body || {}, triggerApp = _a.triggerApp, triggerAction = _a.triggerAction, entityType = _a.entityType, entityId = _a.entityId;
                ...
                try {
                    analysis = (0, complianceGraph_1.analyzeImpact)(triggerApp, triggerAction, entityType, entityId);
