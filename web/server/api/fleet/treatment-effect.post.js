...
exports.default = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                body = (_a.sent());
                if (!Array.isArray(body === null || body === void 0 ? void 0 : body.observations))
                    throw createError({ statusCode: 400, message: 'observations[] required' });
                return [2 /*return*/, (0, fleetAdmin_1.differenceInDifferences)(body.observations)];
        }
    });
}); });
