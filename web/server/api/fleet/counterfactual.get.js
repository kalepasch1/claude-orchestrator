...
exports["default"] = defineEventHandler(function () { return __awaiter(void 0, void 0, void 0, function () {
    var sb, _a, profile, data, autos;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                sb = (0, fleetSupabase_1.serviceClient)();
                return [4 /*yield*/, Promise.all([
                        (0, fleetReads_1.approverDecisions)(sb).then(fleetAdmin_1.buildApproverProfile),
                        sb.from('fleet_admin_actions').select('id,domain,type').eq('tier', 'auto').eq('executed', true).limit(5000),
                    ])];
            case 1:
                _a = _b.sent(), profile = _a[0], data = _a[1].data;
                autos = (data !== null && data !== void 0 ? data : []).map(function (r) { return ({ actionId: r.id, domain: r.domain, actionType: r.type }); });
                return [2 /*return*/, (0, fleetAdmin_1.counterfactualReview)(autos, profile)];
        }
    });
}); });
