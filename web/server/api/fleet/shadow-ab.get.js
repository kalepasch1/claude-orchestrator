...
exports.default = defineEventHandler(function () { return __awaiter(void 0, void 0, void 0, function () {
    var sb, _a, actions, outcomes, base, tight, result;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                sb = (0, fleetSupabase_1.serviceClient)();
                return [4 /*yield*/, (0, fleetReads_1.historyWithOutcomes)(sb)];
            case 1:
                _a = _b.sent(), actions = _a.actions, outcomes = _a.outcomes;
                base = (0, fleetAdmin_1.fleetAdminConstitution)();
                tight = (0, fleetAdmin_1.factionVariants)(base).find(function (f) { return f.name === 'tight'; });
                result = (0, fleetAdmin_1.runShadowAB)({
