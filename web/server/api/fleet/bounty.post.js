...
exports.default = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                body = (_c.sent());
                if (!Array.isArray(body === null || body === void 0 ? void 0 : body.submissions))
                    throw createError({ statusCode: 400, message: 'submissions[] required' });
                return [2 /*return*/, (0, fleetAdmin_1.runBountyRound)(body.submissions)];
        }
    });
}); });
