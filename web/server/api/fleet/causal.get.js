...
exports.default = defineEventHandler(function () { return __awaiter(void 0, void 0, void 0, function () {
    var sb, data, events, graph, incidents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                data = (_a.sent()).data;
                events = (data !== null && data !== void 0 ? data : []).map(function (r) { return (__assign(__assign({}, r), { subjectId: r.subject_id })); });
                graph = (0, fleetAdmin_1.learnCausalGraph)(events);
                incidents = (0, fleetAdmin_1.correlateEvents)(events).map(function (inc) {
                    var evs = inc.events.map(function (id) { return events.find(function (e) { return e.id === id; }); }).filter(Boolean);
                    var rc = (0, fleetAdmin_1.rootCause)(evs, graph);
                    return { id: inc.id, products: inc.products, rootCause: rc ? { id: rc.id, product: rc.product, category: rc.category, at: rc.at } : null };
                });
                return [2 /*return*/, { graph: graph, incidents: incidents, edges: graph.length }];
        }
    });
}); });
