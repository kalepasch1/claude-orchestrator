...
exports["default"] = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var secret, body, composed, verdict;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                body = (_c.sent());
                if (!(body === null || body === void 0 ? void 0 : body.goal) || !(body === null || body === void 0 ? void 0 : body.product))
                    throw createError({ statusCode: 400, message: 'goal + product required' });
                composed = (0, fleetAdmin_1.composeIntentPlan)({ goal: body.goal, subjectId: body.subjectId, product: body.product, amountUsd: body.amountUsd, exemplars: body.exemplars });
                verdict = (0, fleetAdmin_1.governIntent)({ plan: composed.plan });
                return [2 /*return*/, { composed: composed, verdict: verdict }];
        }
    });
}); });
