...
exports.default = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 1:
                fixingActionId = (_g.sent()).fixingActionId;
                if (!fixingActionId)
                    throw createError({ statusCode: 400, message: 'fixingActionId required' });
                sb = (0, fleetSupabase_1.serviceClient)();
                return [4 /*yield*/, sb.from('fleet_admin_actions').select('*').eq('id', fixingActionId).maybeSingle()];
            case 2:
                actRow = (_g.sent()).data;
                if (!actRow)
            ...
            case 3:
                evRows = (_g.sent()).data;
                events = (evRows !== null && evRows !== void 0 ? evRows : []).map(function (r) { return (__assign(__assign({}, r), { subjectId: r.subject_id })); });
                fixing = {
                ...
                if (!incident)
                    return [2 /*return*/, { proposals: [], total: 0, reason: 'fixing action not part of a correlated incident' }];
                proposals = (0, fleetAdmin_1.propagateFix)(incident, fixing, events);
                return [2 /*return*/, { incidentId: incident.id, proposals: proposals, total: proposals.length }];
        }
    });
}); });
