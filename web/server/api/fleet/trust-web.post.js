...
exports.default = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                data = (_b.sent()).data;
                summaries = (data !== null && data !== void 0 ? data : []).map(function (r) { var _a; return ({ domain: r.domain, decision: r.decision, tier: (_a = r.tier) !== null && _a !== void 0 ? _a : 'human', at: r.created_at }); });
