...
exports.default = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var windowMs, sb, data, events, incidents;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                windowMs = Number((_a = getQuery(event).windowMin) !== null && _a !== void 0 ? _a : 15) * 60 * 1000;
            ...
            case 1:
                ...
                incidents = (0, fleetAdmin_1.correlateEvents)(events, windowMs);
                return [2 /*return*/, { incidents: incidents, total: incidents.length }];
        }
    });
}); });
