...
exports.default = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var body, sb, federatedSeed, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, readBody(event)];
            case 1:
                body = (_c.sent());
                if (!(body === null || body === void 0 ? void 0 : body.product) || !Array.isArray(body.expected))
                    throw createError({ statusCode: 400, message: 'product + expected[] required' });
                sb = (0, fleetSupabase_1.serviceClient)();
                _a = fleetAdmin_1.seedFromFederated;
                _b = fleetAdmin_1.buildFederatedPrecedent;
                return [4 /*yield*/, (0, fleetReads_1.appTypeStats)(sb)];
            case 2:
                federatedSeed = _a.apply(void 0, [_b.apply(void 0, [_c.sent()])]);
                return [2 /*return*/, (0, fleetAdmin_1.projectNewApp)({ product: body.product, expected: body.expected, federatedSeed: federatedSeed, ceilingOf: function (d) { return fleetAdmin_1.DEFAULT_DOMAIN_POLICIES[d].ceiling; } })];
        }
    });
}); });
