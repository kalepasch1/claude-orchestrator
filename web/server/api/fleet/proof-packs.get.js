...
exports["default"] = defineEventHandler(function () { return __awaiter(void 0, void 0, void 0, function () {
    var sb, _a, brainRows, brainError, receiptRows;
    var _b;
        ...
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, sb
                        ...
                        .limit(50)];
            case 1:
                _a = _c.sent(), brainRows = _a.data, brainError = _a.error;
                return [4 /*yield*/, sb
                        .from('fleet_receipts')
                        ...
                        .limit(20)];
            case 2:
                receiptRows = (_c.sent()).data;
                return [2 /*return*/, {
                        commonBrain: brainRows !== null && brainRows !== void 0 ? brainRows : [],
                        receipts: receiptRows !== null && receiptRows !== void 0 ? receiptRows : [],
                        error: (_b = brainError === null || brainError === void 0 ? void 0 : brainError.message) !== null && _b !== void 0 ? _b : null,
