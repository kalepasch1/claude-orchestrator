        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                actions = (data !== null && data !== void 0 ? data : []).map(function (r) {
                    var _a;
                    return ({
                        domain: r.domain, decision: r.decision, tier: (_a = r.tier) !== null && _a !== void 0 ? _a : 'human', at: r.created_at
                    });
                });
                splitAt = new Date(Date.now() - 14 * 24 * 3600 * 1000).toISOString();
                return [2 /*return*/, (0, fleetAdmin_1.computeNorthStar)(actions, splitAt)];
        }
    });
}); });
