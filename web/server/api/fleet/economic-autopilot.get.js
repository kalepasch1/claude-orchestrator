        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                inputs = entries
                    ...
                    .map(function (e) { return ({ domain: e.domain, actionType: e.actionType, volume: e.total, cleanRate: e.cleanApprovals / e.total }); });
                dial = (0, fleetAdmin_1.optimizeDial)(inputs, function (d) { return fleetAdmin_1.DEFAULT_DOMAIN_POLICIES[d].ceiling; });
                return [2 /*return*/, dial];
        }
    });
}); });
