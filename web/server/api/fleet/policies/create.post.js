    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                policy = {
                    id: "policy-".concat(Date.now(), "-").concat(Math.random().toString(36).slice(2, 8)),
                    name: body.name,
                    ...
                    enabled: true,
                    auto_execute: (_a = body.autoExecute) !== null && _a !== void 0 ? _a : false,
                    created_at: new Date().toISOString(),
                    match_count: 0,
                    success_count: 0
                };
                return [4 /*yield*/, sb.from('fleet_policies').insert(policy)];
            case 2:
                error = (_b.sent()).error;
                if (error)
