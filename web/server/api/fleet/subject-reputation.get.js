...
exports["default"] = defineEventHandler(function () { return __awaiter(void 0, void 0, void 0, function () {
    var sb, data, signals, reputations;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                data = (_a.sent()).data;
                signals = (data !== null && data !== void 0 ? data : [])
                    .filter(function (r) { return KIND[r.category]; })
                    .map(function (r) { return ({ subjectId: r.subject_id, product: r.product, kind: KIND[r.category], at: r.at }); });
                reputations = (0, fleetAdmin_1.fuseReputation)(signals);
                return [2 /*return*/, { reputations: reputations, atRisk: reputations.filter(function (r) { return r.score < 0.3; }) }];
        }
    });
}); });
