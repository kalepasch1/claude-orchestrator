...
exports.default = defineEventHandler(function () { return __awaiter(void 0, void 0, void 0, function () {
    var sb, _a, bundles, standalone, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                sb = (0, fleetSupabase_1.serviceClient)();
                _b = fleetAdmin_1.bundleQueue;
                return [4 /*yield*/, (0, fleetReads_1.pendingDecisions)(sb)];
            case 1:
                _a = _b.apply(void 0, [_c.sent()]), bundles = _a.bundles, standalone = _a.standalone;
                return [2 /*return*/, { bundles: bundles, standalone: standalone, bundledSubjects: bundles.length }];
        }
    });
}); });
