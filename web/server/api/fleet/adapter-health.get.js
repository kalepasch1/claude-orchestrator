    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = fleetAdmin_1.assessAdapterHealth;
                return [4 /*yield*/, (0, fleetReads_1.executionOutcomes)(sb)];
            case 1:
                reports = _a.apply(void 0, [_b.sent()]);
                return [2 /*return*/, { reports: reports, failing: reports.filter(function (r) { return r.status === 'failing'; }) }];
        }
    });
}); });
