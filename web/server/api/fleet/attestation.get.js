...
exports.default = defineEventHandler(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                data = (_a.sent()).data;
                actions = (data !== null && data !== void 0 ? data : []).map(function (r) { var _a; return ({ domain: r.domain, decision: r.decision, tier: (_a = r.tier) !== null && _a !== void 0 ? _a : 'human', at: r.created_at }); });
                ns = (0, fleetAdmin_1.computeNorthStar)(actions);
                envelope = (0, fleetAdmin_1.coEvolve)();
