...
exports["default"] = defineEventHandler(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                history = _a.sent();
                proposals = (0, fleetAdmin_1.proposeAmendments)(history);
                return [2 /*return*/, { proposals: proposals, total: proposals.length, basisSample: history.length }];
        }
    });
}); });
