...
exports.default = defineEventHandler(function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var body, threats, withWarn;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, readBody(event)];
            case 1:
                body = (_a.sent());
                if (!Array.isArray(body === null || body === void 0 ? void 0 : body.signals))
                    throw createError({ statusCode: 400, message: 'signals[] required' });
                threats = (0, fleetAdmin_1.mergeFederatedThreats)(body.signals);
                withWarn = threats.map(function (t) { return (__assign(__assign({}, t), { warn: body.allPlaneIds ? (0, fleetAdmin_1.planesToWarn)(t, body.allPlaneIds) : [] })); });
                return [2 /*return*/, { threats: withWarn, elevated: withWarn.filter(function (t) { return t.elevated; }).length }];
        }
    });
}); });
