    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                plan = (0, fleetAdmin_1.planIntent)({ goal: body.goal, subjectId: body.subjectId, product: body.product, amountUsd: body.amountUsd });
                verdict = (0, fleetAdmin_1.governIntent)({ plan: plan });
                return [2 /*return*/, { plan: plan, verdict: verdict }];
        }
    });
}); });
