...
// The envelope half lives in shared/ so the embed PAGE can import it without
// dragging node:crypto into the client bundle. Re-exported here so every existing
// server-side import of this module is unchanged. See shared/embedProtocol.ts.
export * from '../../shared/embedProtocol'
import {
  EMBED_SURFACES,
  type EmbedSurface,
