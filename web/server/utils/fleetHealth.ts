...
/**
 * Summarize the shared runner-heartbeat ledger. This deliberately does not read a
 * machine-local sentinel: the dashboard runs on Vercel, while the fleet runs on
 * several Macs, so a local file can never be authoritative for production health.
 */
