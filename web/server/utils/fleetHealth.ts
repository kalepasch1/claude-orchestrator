...
/**
 * Summarize the shared heartbeat ledger. A Vercel-local sentinel file can only
 * describe the serverless instance reading it; it cannot describe the Macs that
 * actually claim and execute work.
 */
