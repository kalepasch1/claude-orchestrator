...
exports.ledgerEntries = exports.pendingDecisions = exports.settledDecisions = exports.historyWithOutcomes = exports.executionOutcomes = exports.appTypeStats = exports.exposureFor = exports.approverDecisions = exports.resolvedHistory = void 0;
            ...
            switch (_c.label) {
                ...
                case 1:
                    ...
                    for (_i = 0, _b = (data !== null && data !== void 0 ? data : []); _i < _b.length; _i++) {
                        ...
                        s = (_a = map.get(k)) !== null && _a !== void 0 ? _a : { product: r.act.product, domain: r.act.domain, actionType: r.act.type, total: 0, cleanApprovals: 0 };
                        s.total += 1;
...
function historyWithOutcomes(sb) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var data, actions, outcomes, _i, _c, r;
                ...
                case 1:
                    ...
                    for (_i = 0, _c = (data !== null && data !== void 0 ? data : []); _i < _c.length; _i++) {
                        ...
                        actions.push({
                            ...
                            subjectId: (_a = r.act.subject_id) !== null && _a !== void 0 ? _a : undefined, amountUsd: (_b = r.act.amount_usd) !== null && _b !== void 0 ? _b : undefined, confidence: Number(r.act.confidence),
