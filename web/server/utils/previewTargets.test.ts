...
describe('embedded preview targets', () => {
  it('covers every application workspace with a durable HTTPS alias', () => {
    expect(Object.keys(PREVIEW_TARGETS).sort()).toEqual(['apparently', 'beethoven', 'darwn', 'pareto-2080', 'racefeed', 'santas-secret-workshop', 'smarter', 'sustainable-barks', 'tomorrow'])
