...
def test_clean_run_builds_a_contiguous_chain():
    ...
    landed, dropped, _orphaned = _insert_chain(_parts(5), _make_row, lambda s: False, insert)
...
def test_dropped_first_slice_leaves_the_successor_unblocked():
    ...
    landed, dropped, _orphaned = _insert_chain(_parts(3), _make_row, lambda s: False, insert)
...
def test_consecutive_drops_collapse_to_the_last_survivor():
    ...
    landed, dropped, _orphaned = _insert_chain(_parts(4), _make_row, lambda s: False, insert)
...
def test_every_slice_dropped_reports_nothing_landed():
    ...
    landed, dropped, _orphaned = _insert_chain(_parts(2), _make_row, lambda s: False, insert)
...
def test_attempts_of_one_disables_the_retry():
    insert, written, seen = _recorder(fail_once={"p-slice-2"})
    landed, dropped, _orphaned = _insert_chain(
...
def test_planned_deps_on_the_part_are_ignored_in_favour_of_what_landed():
    ...
    landed, dropped, _orphaned = _insert_chain(parts, _make_row, lambda s: False, insert)
