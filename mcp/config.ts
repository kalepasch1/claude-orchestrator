...
export const APP_SOURCES: Record<string, AppSource> = {
  ...
  vigil: { id: 'vigil', label: 'Vigil', baseUrl: 'https://vigil.heretomorrow.us', devUrl: 'http://localhost:3001', icon: '⊘', category: 'SupTech Platform', pricingTier: 'enterprise', costProfile: { aiCallsPerRequest: 1.5, avgLatencyMs: 4000, estimatedCostPerCall: 0.12 }, repoPath: '/Users/kpasch/Documents/vigil', apiScanGlob: 'server/api/**/*.ts', engineScanGlob: 'server/engines/**/*.ts' },
  ...
  tomorrow: { id: 'tomorrow', label: 'Tomorrow', baseUrl: 'https://tomorrow.trade', devUrl: 'http://localhost:3003', icon: '∞', category: 'OTC Derivatives', pricingTier: 'enterprise', costProfile: { aiCallsPerRequest: 0.8, avgLatencyMs: 2500, estimatedCostPerCall: 0.06 }, repoPath: '/Users/kpasch/Documents/tomorrow/tomorrow', apiScanGlob: 'server/api/**/*.ts', engineScanGlob: 'server/utils/**/*.ts' },
