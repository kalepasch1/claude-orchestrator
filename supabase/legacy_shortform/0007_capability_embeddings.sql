-- v3.5: store capability embeddings for O(1) pgvector dedup + semantic radar.
-- Requires the `vector` extension (already enabled in 0001_init.sql).
...
-- RPC: find nearest capability by cosine similarity (used by publish() dedup check).
