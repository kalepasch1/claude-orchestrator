...
_Generated 2026-08-17T23:31:59.748201+00:00 — 30-day window_

## Direct cost efficiency (ratios, not cumulative totals)
- Merge rate: 0.224
- First-pass rate: 0.275
- $/merge (all): 0.0
- $/merge (fresh, non-reuse only — the real per-unit cost baseline): 0.0
- Tokens/merge: 0.0
...
- Counterfactual cost per event (avg fresh merge): $0.0
- Gross avoided spend: $0.0
- Net avoided spend (after actual $ spent on reuse events): $0.0
...
- Our $/solve (fresh, non-reuse): $0.0
- **Per-token verdict: our measured $/solve is at or below DeepSeek's list-price equivalent**
- Portfolio coverage (233 units — n_merged + additive reuse): DeepSeek-with-no-reuse would cost $0.0 raw, $0.0 quality-adjusted; our actual cost was $0.0
...
## Blended cost per unit of delivered value: $0.0
