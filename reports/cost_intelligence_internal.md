...
_Generated 2026-08-05T01:31:45.419424+00:00 — 30-day window_

## Direct cost efficiency (ratios, not cumulative totals)
- Merge rate: 0.267
- First-pass rate: 0.33
- $/merge (all): 0.0088
- $/merge (fresh, non-reuse only — the real per-unit cost baseline): 0.0069
- Tokens/merge: 306.2
...
- Counterfactual cost per event (avg fresh merge): $0.0069
- Gross avoided spend: $0.06
- Net avoided spend (after actual $ spent on reuse events): $0.06

## Competitor comparison — DeepSeek API (list pricing)
- DeepSeek V4-Flash: $0.14/1M in, $0.28/1M out
- DeepSeek raw $/solve (our token footprint, their price): $0.0001
- Our $/solve (fresh, non-reuse): $0.0069
- **Per-token verdict: we cost more per raw token than DeepSeek — do not claim otherwise**
- Portfolio coverage (276 units — n_merged + additive reuse): DeepSeek-with-no-reuse would cost $0.02 raw, $0.03 quality-adjusted; our actual cost was $2.34
...
## Blended cost per unit of delivered value: $0.0085
