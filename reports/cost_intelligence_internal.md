...
_Generated 2026-08-04T05:12:31.396101+00:00 — 30-day window_

## Direct cost efficiency (ratios, not cumulative totals)
- Merge rate: 0.243
- First-pass rate: 0.29
- $/merge (all): 0.0076
- $/merge (fresh, non-reuse only — the real per-unit cost baseline): 0.0076
- Tokens/merge: 355.4
...
- Counterfactual cost per event (avg fresh merge): $0.0076
- Gross avoided spend: $0.07
- Net avoided spend (after actual $ spent on reuse events): $0.07
...
- Our $/solve (fresh, non-reuse): $0.0076
- **Per-token verdict: we cost more per raw token than DeepSeek — do not claim otherwise**
- Portfolio coverage (252 units — n_merged + additive reuse): DeepSeek-with-no-reuse would cost $0.02 raw, $0.03 quality-adjusted; our actual cost was $1.85
...
## Blended cost per unit of delivered value: $0.0073
