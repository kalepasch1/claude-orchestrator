...
Baseline gap vs DeepSeek (quality-adjusted, per unit of value): 85.0x

## Stage 0 - baseline (measured or last-computed)
- Projected blended cost/unit: $0.0085
- Gap vs DeepSeek (quality-adjusted): 85.0x
- _No projected change applied. This is the input, not a target._

## Stage 1 - near-term (levers already merged, not yet at scale)
- Projected blended cost/unit: $0.003
- Gap vs DeepSeek (quality-adjusted): 30.0x
...
- Projected blended cost/unit: $0.0013
- Gap vs DeepSeek (quality-adjusted): 13.0x
...
- Projected blended cost/unit: $0.0003
- Gap vs DeepSeek (quality-adjusted): 3.0x
...
## Verdict
Under Stage 3's aggressive/aspirational assumptions, projected improvement is 28.3x over baseline (does not reach the 50x threshold, does not reach the 500x threshold). Even at this upper bound we remain 3.0x DeepSeek's quality-adjusted portfolio-equivalent cost per unit — closing the remainder requires either DeepSeek's price rising, our quality edge widening beyond the sourced benchmark gap, or reuse/zero-token levers exceeding what is modeled here as aggressive.
